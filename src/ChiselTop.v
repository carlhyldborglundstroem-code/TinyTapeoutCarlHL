...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [31:0] _GEN_140 = playTimer >= 32'h5f5e100 ? 32'h0 : _playTimer_T_1; // @[ChiselTop.scala 287:22 289:42 290:23]
  wire [3:0] _GEN_141 = playTimer >= 32'h5f5e100 ? _GEN_137 : count; // @[ChiselTop.scala 289:42 84:25]
  wire [1:0] _GEN_142 = playTimer >= 32'h5f5e100 ? _GEN_138 : state; // @[ChiselTop.scala 289:42 81:25]
  wire [3:0] _GEN_143 = playTimer >= 32'h5f5e100 ? _GEN_139 : playIdx; // @[ChiselTop.scala 289:42 85:25]
  ...
  wire [3:0] _GEN_168 = cntReg == 32'h2625a0 ? _GEN_166 : brightness; // @[ChiselTop.scala 306:35 49:32]
  wire  _GEN_169 = cntReg == 32'h2625a0 ? _GEN_167 : changeDirection; // @[ChiselTop.scala 306:35 50:32]
  ...
  always @(posedge clock) begin
    ...
    end else if (cntReg == 32'h989680) begin // @[ChiselTop.scala 129:32]
    ...
    end else if (blinkTimer >= 32'h17d7840) begin // @[ChiselTop.scala 93:34]
